...
A2: 
Run with Raw Audio CNN. Using both cut-off filter and smooth filter. 
"""
...
from H_1_models import CNNDirectNetworkSmall
...
def run_once(hyper_dir, model_type="large", pretype="f", posttype="f", sel="full", preepochs=20, postepochs=20): 
    ...
    with open(model_txt_path, "w") as f:
        f.write(model_str)
        f.write("\n")
        f.write(str(summary(model, input_size=(128, 1, 4000))))
